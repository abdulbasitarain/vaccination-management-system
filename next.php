            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div id="exTab2">	
                    <!-- <ul class="nav nav-tabs">
			            <li class="active">
                            <a  href="#1" data-toggle="tab" class="btn btn-danger">Next Vaccine</a>
			           </li>
		           </ul> -->

			        <div class="tab-content ">
			            <div class="tab-pane active" id="1">
                            <h3 style="padding-top: 30px;" class=" font-weight-bolder">Next Vaccine</h3>
                            <h3 class="pt-3 font-weight-bold">You are with us from <?php echo $rschild['admissiondate']; ?> </h3>
                            <h3>Your next vaccine dose will be after 3 months of the 1st vaccine dose</h3>
			        	</div>
			        </div>
                </div>
            </div>
